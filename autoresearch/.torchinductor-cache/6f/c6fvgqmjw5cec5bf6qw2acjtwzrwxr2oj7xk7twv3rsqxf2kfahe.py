...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/vv/cvvy27poypubghnsfg5kwxsxsfwvqbiu6ucrszbzyvtg6qc6x5hc.py
...
#   %copy_ : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=copy_]
#   %copy__1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=copy__1]
#   %sum_1 : Tensor "f32[4, 1, 1][1, 4, 4]cuda:0" = PlaceHolder[target=sum_1]
#   %add_1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=add_1]
#   %expand_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %add : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=add]
...
#   %sub_2 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg1_1, %arg2_1), kwargs = {})
#   %mul : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where, %sub_2), kwargs = {})
#   %where_1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge, %arg1_1, %arg2_1), kwargs = {})
#   %add : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %where_1), kwargs = {})
#   %sub_4 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add, %arg1_1), kwargs = {})
#   %mul_1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_2, %sub_4), kwargs = {})
#   %where_3 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %add, %arg1_1), kwargs = {})
#   %add_1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_1, %where_3), kwargs = {})
#   %convert_element_type : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.bfloat16), kwargs = {})
#   %convert_element_type_1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_1, 2), kwargs = {})
#   %sum_1 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%pow_1, [-2, -1], True), kwargs = {})
#   %pow_2 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_1, 0.5), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_2, torch.bfloat16), kwargs = {})
#   %mul_2 : Tensor "bf16[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_2, 1.02), kwargs = {})
#   %add_2 : Tensor "bf16[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_2, 1e-06), kwargs = {})
#   %div : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type, %add_2), kwargs = {})
#   %copy_ : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg1_1, %add_1), kwargs = {})
#   %copy__1 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg2_1, %add), kwargs = {})
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/i2/ci2x3q4lqm3t42fpmq272njiu3sd5edwq2b56vrsw6pncdsdyck2.py
...
#   mul_2 => mul_4
# Graph fragment:
#   %expand_3 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=expand_3]
#   %bmm_1 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=bmm_1]
#   %mul_3 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm, -22.48329292557795), kwargs = {})
#   %mul_4 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_1, 15.878769915207462), kwargs = {})
#   %add_3 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_3, %mul_4), kwargs = {})
#   return %expand_4
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/zn/czn3coalfjnjpabctzutab5ie2h44m5ho23ur7nhighsnbcqw2jp.py
...
# Graph fragment:
#   %expand_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %bmm_2 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %mul_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   return %expand_11
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/p5/cp5gh7uq64qcrt6dn655qkdanc3o5v5k7yv4r3ne2funwtougutn.py
...
#   mul_5 => mul_7
# Graph fragment:
#   %expand_9 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=expand_9]
#   %bmm_4 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=bmm_4]
#   %mul_6 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_3, -2.808917465908714), kwargs = {})
#   %mul_7 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_4, 0.5000178451051316), kwargs = {})
#   %add_5 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_6, %mul_7), kwargs = {})
#   return %expand_10
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/7j/c7javyytigrvx73qtklxrdddamztj2d6epbrwgnf2fgddulix33z.py
...
#   %expand_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %bmm_2 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %bmm_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %mul_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   return %expand_17
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/vv/cvvluhvkj36joms3yjs34u2ogytet73zrt6ofif5dhsgrotlqypo.py
...
#   mul_8 => mul_10
# Graph fragment:
#   %expand_15 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=expand_15]
#   %bmm_7 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=bmm_7]
#   %mul_9 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_6, -2.772484153217685), kwargs = {})
#   %mul_10 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_7, 0.5060648178503393), kwargs = {})
#   %add_7 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_9, %mul_10), kwargs = {})
#   return %expand_16
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/zt/cztsjfezeq2cwf3u6stz22hdoos6gh46b5oxn3a2w7ezk63dsmlk.py
...
#   %bmm_2 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %bmm_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %bmm_8 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_8]
#   %mul_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   %mul_11 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_6, 3.8916678022926607), kwargs = {})
#   %add_8 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %bmm_8), kwargs = {})
#   return %expand_23
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/ho/chou24rqrav6pfn2ms36xraqo7nm356rtj4kxkaksrplq7o7p57q.py
...
#   mul_11 => mul_13
# Graph fragment:
#   %expand_21 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=expand_21]
#   %bmm_10 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=bmm_10]
#   %mul_12 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_9, -2.3681294933425376), kwargs = {})
#   %mul_13 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_10, 0.46449024233003106), kwargs = {})
#   %add_9 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_12, %mul_13), kwargs = {})
#   return %expand_22
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/ag/cagc5nxx7jhnm2hrp4ey56zdjgbui3cue4gqm4w74ez4jckcq2up.py
...
#   %bmm_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %bmm_8 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_8]
#   %bmm_11 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_11]
#   %mul_5 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   %mul_11 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_6, 3.8916678022926607), kwargs = {})
#   %add_8 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %bmm_8), kwargs = {})
#   %mul_14 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, 3.285753657755655), kwargs = {})
#   %add_10 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_14, %bmm_11), kwargs = {})
#   return %expand_29
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/x7/cx7yzvqeih7wv5kk4crxpuxofjr7cdhjtc4ek7uqn4nnxb3y5azv.py
...
#   mul_14 => mul_16
# Graph fragment:
#   %expand_27 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=expand_27]
#   %bmm_13 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0" = PlaceHolder[target=bmm_13]
#   %mul_15 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_12, -1.7097828382687081), kwargs = {})
#   %mul_16 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_13, 0.42323551169305323), kwargs = {})
#   %add_11 : Tensor "bf16[4, 4, 4][16, 4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_15, %mul_16), kwargs = {})
#   return %expand_28
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/ti/ctiypthphpib4hrsqoxij2mwfwy6mqtfmff6sed2s6gmc55og3o4.py
...
#   v_norm_sq => mul_18
# Graph fragment:
#   %expand_29 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=expand_29]
#   %bmm_14 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_14]
#   %mean : Tensor "f32[4, 1, 32][32, 128, 1]cuda:0" = PlaceHolder[target=mean]
#   %arg3_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg3_1]
#   %copy__2 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0" = PlaceHolder[target=copy__2]
#   %sum_2 : Tensor "f32[4, 1, 1][1, 4, 4]cuda:0" = PlaceHolder[target=sum_2]
#   %sum_3 : Tensor "f32[4, 1, 1][1, 4, 4]cuda:0" = PlaceHolder[target=sum_3]
#   %add_13 : Tensor "f32[4, 1, 32][32, 128, 1]cuda:0" = PlaceHolder[target=add_13]
#   %convert_element_type_36 : Tensor "bf16[4, 1, 32][32, 128, 1]cuda:0" = PlaceHolder[target=convert_element_type_36]
#   %mul_17 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, 2.3465413258596377), kwargs = {})
#   %add_12 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %bmm_14), kwargs = {})
#   %convert_element_type_34 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_12, torch.float32), kwargs = {})
#   %pow_3 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_34, 2), kwargs = {})
#   %mean : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_3, [-2], True), kwargs = {})
#   %sum_2 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mean, [-2, -1], True), kwargs = {})
#   %mul_18 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_2, 4), kwargs = {})
#   %sqrt : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%mul_18,), kwargs = {})
#   %mul_20 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mean, 4), kwargs = {})
...
#   %sub_7 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mean, %arg4_1), kwargs = {})
#   %mul_19 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_4, %sub_7), kwargs = {})
#   %where_5 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_2, %mean, %arg4_1), kwargs = {})
#   %add_13 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_19, %where_5), kwargs = {})
#   %clamp_min : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%add_13, 1e-10), kwargs = {})
#   %rsqrt : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%clamp_min,), kwargs = {})
#   %pow_4 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%rsqrt, 2), kwargs = {})
#   %mul_21 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_20, %pow_4), kwargs = {})
#   %sum_3 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_21, [-2, -1], True), kwargs = {})
#   %sqrt_1 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%sum_3,), kwargs = {})
#   %clamp_min_1 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%sqrt_1, 1e-10), kwargs = {})
#   %div_1 : Tensor "f32[4, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sqrt, %clamp_min_1), kwargs = {})
#   %mul_22 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%rsqrt, %div_1), kwargs = {})
#   %convert_element_type_36 : Tensor "bf16[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_22, torch.bfloat16), kwargs = {})
#   %copy__2 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg4_1, %add_13), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_add_clamp_min_copy__div_lerp_mean_mul_pow_rsqrt_rsub_sqrt_sum_10', 'mutated_arg_names': ['in_ptr3', 'out_ptr5'], 'optimize_mem': True, 'no_x_dim': None, 'num_load': 10, 'num_reduction': 2, 'backend_hash': '168E8D72A2911C3B3764FBC9919500356717EE403883CBFEFAE47391A8A6994A', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'tiling_scores': {'x': 0, 'r0_': 4096}}
)
@triton.jit
def triton_per_fused__to_copy_add_clamp_min_copy__div_lerp_mean_mul_pow_rsqrt_rsub_sqrt_sum_10(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr3, out_ptr5, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr1 + (r0_1 + 128*x0), xmask, other=0.0).to(tl.float32)
    tmp7 = tl.load(in_ptr0 + (32 + r0_1 + 128*x0), xmask, other=0.0).to(tl.float32)
    tmp9 = tl.load(in_ptr1 + (32 + r0_1 + 128*x0), xmask, other=0.0).to(tl.float32)
    tmp14 = tl.load(in_ptr0 + (64 + r0_1 + 128*x0), xmask, other=0.0).to(tl.float32)
    tmp16 = tl.load(in_ptr1 + (64 + r0_1 + 128*x0), xmask, other=0.0).to(tl.float32)
    tmp21 = tl.load(in_ptr0 + (96 + r0_1 + 128*x0), xmask, other=0.0).to(tl.float32)
    tmp23 = tl.load(in_ptr1 + (96 + r0_1 + 128*x0), xmask, other=0.0).to(tl.float32)
    tmp35 = in_ptr2
    tmp45 = tl.load(in_ptr3 + (r0_1 + 32*x0), xmask, other=0.0)
    ...
    tmp46 = tmp29 - tmp45
    tmp47 = tmp44 * tmp46
    tmp48 = tl.where(tmp42, tmp29, tmp45)
    tmp49 = tmp47 + tmp48
    tmp50 = 1e-10
    ...
    tmp61 = libdevice.sqrt(tmp58)
    tmp62 = triton_helpers.maximum(tmp61, tmp50)
    tmp63 = (tmp60 / tmp62)
    tmp64 = tmp52 * tmp63
    tmp65 = tmp64.to(tl.float32)
    tl.store(out_ptr3 + (r0_1 + 32*x0), tmp65, xmask)
    tl.store(out_ptr5 + (r0_1 + 32*x0), tmp49, xmask)
''', device_str='cuda')


# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/m2/cm2yziwdfzcrxpdlwmhwqkqe2wyxrxogfpao36ilz5vhdzf6r6pt.py
...
# Graph fragment:
#   %copy__3 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=copy__3]
#   %arg5_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg5_1]
#   %expand_29 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=expand_29]
#   %bmm_14 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=bmm_14]
#   %convert_element_type_36 : Tensor "bf16[4, 1, 32][32, 128, 1]cuda:0" = PlaceHolder[target=convert_element_type_36]
#   %arg6_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg6_1]
#   %sub_8 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0" = PlaceHolder[target=sub_8]
...
#   %mul_22 : Tensor "f32[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%rsqrt, %div_1), kwargs = {})
#   %convert_element_type_36 : Tensor "bf16[4, 1, 32][32, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_22, torch.bfloat16), kwargs = {})
#   %mul_23 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_12, %convert_element_type_36), kwargs = {})
#   %mul_25 : Tensor "bf16[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_37, %mul_23), kwargs = {})
...
#   %mul_27 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_26, %arg7_1), kwargs = {})
#   %mul_24 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_23, %arg7_1), kwargs = {})
#   %ge_3 : Tensor "b8[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%mul_24, 0), kwargs = {})
#   %mul_28 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_27, %ge_3), kwargs = {})
#   %add_14 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_25, %mul_28), kwargs = {})
#   %sub_8 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg7_1, %add_14), kwargs = {})
#   %copy__3 : Tensor "f32[4, 4, 32][128, 32, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg7_1, %sub_8), kwargs = {})
#   return %sub_8,%buf59
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg1_1, (4, 4, 32), (128, 32, 1))
        assert_size_stride(arg2_1, (4, 4, 32), (128, 32, 1))
        assert_size_stride(arg3_1, (), ())
        assert_size_stride(arg4_1, (4, 1, 32), (32, 32, 1))
        assert_size_stride(arg5_1, (), ())
        assert_size_stride(arg6_1, (), ())
        assert_size_stride(arg7_1, (4, 4, 32), (128, 32, 1))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf1 = empty_strided_cuda((4, 4, 32), (128, 32, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [g, sub, lerp_, X, norm, mul, add, X_1], Original ATen: [aten.lerp, aten.rsub, aten._to_copy, aten.linalg_vector_norm, aten.mul, aten.add, aten.div, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_copy__div_lerp_linalg_vector_norm_mul_rsub_0.run(arg0_1.item(), arg1_1, arg2_1, buf1, arg1_1, arg2_1, 4, 128, stream=stream0)
            del arg0_1
            del arg1_1
            del arg2_1
            buf2 = empty_strided_cuda((4, 4, 4), (16, 4, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getattr_1, A], Original ATen: [aten.transpose, aten.bmm]
            extern_kernels.bmm(buf1, reinterpret_tensor(buf1, (4, 32, 4), (128, 1, 32), 0), out=buf2)
            buf3 = empty_strided_cuda((4, 4, 4), (16, 4, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_1], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf2, buf2, out=buf3)
            buf4 = buf2; del buf2  # reuse
            # Topologically Sorted Source Nodes: [mul_1, mul_2, B], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_1.run(buf4, buf3, 64, stream=stream0)
            buf5 = empty_strided_cuda((4, 4, 32), (128, 32, 1), torch.bfloat16)
            ...
            buf6 = empty_strided_cuda((4, 4, 32), (128, 32, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_3, X_2], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_2.run(buf1, buf5, buf6, 512, stream=stream0)
            buf7 = buf4; del buf4  # reuse
            # Topologically Sorted Source Nodes: [mul_3, X_2, getattr_2, A_1], Original ATen: [aten.mul, aten.add, aten.transpose, aten.bmm]
            extern_kernels.bmm(buf6, reinterpret_tensor(buf6, (4, 32, 4), (128, 1, 32), 0), out=buf7)
            ...
            # Topologically Sorted Source Nodes: [mul_4, mul_5, B_1], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_3.run(buf9, buf8, 64, stream=stream0)
            buf10 = empty_strided_cuda((4, 4, 32), (128, 32, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_3, X_2, mul_6, X_3], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_4.run(buf1, buf5, buf10, buf11, 512, stream=stream0)
            ...
            extern_kernels.bmm(buf11, reinterpret_tensor(buf11, (4, 32, 4), (128, 1, 32), 0), out=buf12)
            ...
            # Topologically Sorted Source Nodes: [mul_7, mul_8, B_2], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_5.run(buf14, buf13, 64, stream=stream0)
            buf15 = empty_strided_cuda((4, 4, 32), (128, 32, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_3, X_2, mul_6, X_3, mul_9, X_4], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_6.run(buf1, buf5, buf10, buf15, buf16, 512, stream=stream0)
            ...
            extern_kernels.bmm(buf16, reinterpret_tensor(buf16, (4, 32, 4), (128, 1, 32), 0), out=buf17)
            ...
            # Topologically Sorted Source Nodes: [mul_10, mul_11, B_3], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_7.run(buf19, buf18, 64, stream=stream0)
            del buf18
            buf20 = empty_strided_cuda((4, 4, 32), (128, 32, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_3, X_2, mul_6, X_3, mul_9, X_4, mul_12, X_5], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_8.run(buf21, buf5, buf10, buf15, buf20, 512, stream=stream0)
            del buf10
            del buf15
            del buf20
            buf22 = buf19; del buf19  # reuse
            # Topologically Sorted Source Nodes: [getattr_5, A_4], Original ATen: [aten.transpose, aten.bmm]
            extern_kernels.bmm(buf21, reinterpret_tensor(buf21, (4, 32, 4), (128, 1, 32), 0), out=buf22)
            buf23 = empty_strided_cuda((4, 4, 4), (16, 4, 1), torch.bfloat16)
            ...
            # Topologically Sorted Source Nodes: [mul_13, mul_14, B_4], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_9.run(buf24, buf23, 64, stream=stream0)
            del buf23
            ...
            del buf24
            buf29 = empty_strided_cuda((4, 1, 32), (32, 128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_15, X_6, float_1, square, v_mean, sum_1, v_norm_sq, v_norm, mul_17, beta2, sub_1, lerp__2, clamp_min, step_size, square_1, scaled_sq_sum, sum_2, v_norm_new, clamp_min_1, truediv_1, final_scale, to_3], Original ATen: [aten.mul, aten.add, aten._to_copy, aten.pow, aten.mean, aten.sum, aten.sqrt, aten.rsub, aten.lerp, aten.clamp_min, aten.rsqrt, aten.div, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_clamp_min_copy__div_lerp_mean_mul_pow_rsqrt_rsub_sqrt_sum_10.run(buf21, buf25, arg3_1.item(), arg4_1, buf29, arg4_1, 4, 32, stream=stream0)
            del arg3_1
            del arg4_1
            # Topologically Sorted Source Nodes: [lr, mul_15, X_6, v_norm_sq, v_norm, beta2, sub_1, lerp__2, clamp_min, step_size, v_norm_new, clamp_min_1, truediv_1, final_scale, to_3, g_1, mul_22, wd, mul_23, mul_24, mul_21, mask, mul_25, add_11, sub_], Original ATen: [aten._to_copy, aten.mul, aten.add, aten.sqrt, aten.rsub, aten.lerp, aten.clamp_min, aten.rsqrt, aten.div, aten.ge, aten.sub, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_add_clamp_min_copy__div_ge_lerp_mul_rsqrt_rsub_sqrt_sub_11.run(arg7_1, arg5_1.item(), buf21, buf25, buf29, arg6_1.item(), arg7_1, 512, stream=stream0)
            del arg5_1
            del arg6_1
            del arg7_1
            del buf21
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((4, 4, 32), (128, 32, 1), device='cuda:0', dtype=torch.float32)
    arg2_1 = rand_strided((4, 4, 32), (128, 32, 1), device='cuda:0', dtype=torch.float32)
    arg3_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg4_1 = rand_strided((4, 1, 32), (32, 32, 1), device='cuda:0', dtype=torch.float32)
    arg5_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg6_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg7_1 = rand_strided((4, 4, 32), (128, 32, 1), device='cuda:0', dtype=torch.float32)
