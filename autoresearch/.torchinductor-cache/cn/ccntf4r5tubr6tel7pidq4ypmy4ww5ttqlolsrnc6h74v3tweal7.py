...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/bi/cbiourty3k6efblvfq3s5jijitksljcbqpkuwgd5x4udiexgqppr.py
...
#   %copy__1 : Tensor "f32[8][1]cuda:0" = PlaceHolder[target=copy__1]
#   %arg7_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg7_1]
#   %copy__2 : Tensor "f32[8][1]cuda:0" = PlaceHolder[target=copy__2]
#   %arg8_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg8_1]
#   %arg9_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg9_1]
#   %copy_ : Tensor "f32[8][1]cuda:0" = PlaceHolder[target=copy_]
#   %arg1_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg2_1]
#   %div_2 : Tensor "f32[8][1]cuda:0" = PlaceHolder[target=div_2]
#   %add : Tensor "f32[8][1]cuda:0" = PlaceHolder[target=add]
#   %add_1 : Tensor "f32[8][1]cuda:0" = PlaceHolder[target=add_1]
#   %add_3 : Tensor "f32[8][1]cuda:0" = PlaceHolder[target=add_3]
...
#   %mul_1 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg0_1, %sub), kwargs = {})
...
#   %sub_3 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg5_1, %arg3_1), kwargs = {})
#   %mul_2 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where, %sub_3), kwargs = {})
#   %where_1 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge, %arg5_1, %arg3_1), kwargs = {})
#   %add : Tensor "f32[8][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_2, %where_1), kwargs = {})
...
#   %pow_1 : Tensor "f32[8][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%arg5_1, 2), kwargs = {})
#   %sub_6 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%pow_1, %arg6_1), kwargs = {})
#   %mul_3 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_2, %sub_6), kwargs = {})
#   %where_3 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %pow_1, %arg6_1), kwargs = {})
#   %add_1 : Tensor "f32[8][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_3, %where_3), kwargs = {})
...
#   %div : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%add_1, %sub_8), kwargs = {})
#   %sqrt : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%div,), kwargs = {})
#   %add_2 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sqrt, %arg9_1), kwargs = {})
#   %div_2 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%add, %add_2), kwargs = {})
...
#   %mul_4 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, %neg), kwargs = {})
#   %add_3 : Tensor "f32[8][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_1, %mul_4), kwargs = {})
#   %copy_ : Tensor "f32[8][1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg0_1, %add_3), kwargs = {})
#   %copy__1 : Tensor "f32[8][1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg3_1, %add), kwargs = {})
#   %copy__2 : Tensor "f32[8][1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg6_1, %add_1), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_add_copy__div_lerp_mul_neg_pow_rsub_sqrt_0.run(arg4_1.item(), arg5_1, arg3_1, arg7_1.item(), arg6_1, arg8_1.item(), arg9_1.item(), arg0_1, arg1_1.item(), arg2_1.item(), arg3_1, arg6_1, arg0_1, 8, stream=stream0)
            del arg0_1
            del arg1_1
            del arg2_1
            del arg3_1
