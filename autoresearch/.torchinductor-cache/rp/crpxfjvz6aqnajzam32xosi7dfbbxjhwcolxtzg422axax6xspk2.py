...
#   %copy_ : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=copy_]
#   %copy__1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=copy__1]
...
#   %sub_2 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg1_1, %arg2_1), kwargs = {})
#   %mul : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where, %sub_2), kwargs = {})
#   %where_1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge, %arg1_1, %arg2_1), kwargs = {})
#   %add : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %where_1), kwargs = {})
#   %sub_4 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add, %arg1_1), kwargs = {})
#   %mul_1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_2, %sub_4), kwargs = {})
#   %where_3 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %add, %arg1_1), kwargs = {})
#   %add_1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_1, %where_3), kwargs = {})
#   %convert_element_type : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.bfloat16), kwargs = {})
#   %convert_element_type_1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_1, 2), kwargs = {})
...
#   %add_1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=add_1]
#   %buf0 : Tensor "f32[8, 1, 1, 128][128, 1024, 1024, 1]cuda:0" = PlaceHolder[target=buf0]
#   %expand_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %add : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=add]
#   %abs_2 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%arg0_1,), kwargs = {})
#   %ge_1 : Tensor "b8[][]cpu"[num_users=2] = call_function[target=torch.ops.aten.ge.Scalar](args = (%abs_2, 0.5), kwargs = {})
#   %sub_3 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg0_1, 1), kwargs = {})
#   %where_2 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %sub_3, %arg0_1), kwargs = {})
...
#   %div : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type, %add_2), kwargs = {})
#   %copy_ : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg1_1, %add_1), kwargs = {})
#   %copy__1 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg2_1, %add), kwargs = {})
...
# Graph fragment:
#   %expand_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %bmm_2 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %mul_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   return %expand_11
...
#   %expand_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %bmm_2 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %bmm_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %mul_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   return %expand_17
...
#   %bmm_2 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %bmm_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %bmm_8 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_8]
#   %mul_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   %mul_11 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_6, 3.8916678022926607), kwargs = {})
#   %add_8 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %bmm_8), kwargs = {})
#   return %expand_23
...
#   %bmm_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %bmm_8 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_8]
#   %bmm_11 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_11]
#   %mul_5 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   %mul_11 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_6, 3.8916678022926607), kwargs = {})
#   %add_8 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %bmm_8), kwargs = {})
#   %mul_14 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, 3.285753657755655), kwargs = {})
#   %add_10 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_14, %bmm_11), kwargs = {})
#   return %expand_29
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/dp/cdpin67nunzjatoapu52n2om6oggcnl5zxga4in3ia6mav5evqiz.py
...
#   v_mean => mean
# Graph fragment:
#   %expand_29 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=expand_29]
#   %bmm_14 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_14]
#   %mul_17 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, 2.3465413258596377), kwargs = {})
#   %add_12 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %bmm_14), kwargs = {})
#   %convert_element_type_34 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_12, torch.float32), kwargs = {})
#   %pow_3 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_34, 2), kwargs = {})
#   %mean : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_3, [-2], True), kwargs = {})
#   return %buf27
...
def triton_red_fused__to_copy_add_mean_mul_pow_12(in_ptr0, in_ptr1, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_2 = r0_index
        tmp0 = tl.load(in_ptr0 + (x0 + 2048*r0_2 + 1048576*x1), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
        tmp3 = tl.load(in_ptr1 + (x0 + 2048*r0_2 + 1048576*x1), r0_mask, eviction_policy='evict_first', other=0.0).to(tl.float32)
...
#   v_norm_sq => mul_18
# Graph fragment:
#   %buf27 : Tensor "f32[8, 1, 2048][2048, 16384, 1]cuda:0" = PlaceHolder[target=buf27]
#   %arg3_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg3_1]
#   %copy__2 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0" = PlaceHolder[target=copy__2]
#   %sum_2 : Tensor "f32[8, 1, 1][1, 8, 8]cuda:0" = PlaceHolder[target=sum_2]
#   %sum_3 : Tensor "f32[8, 1, 1][1, 8, 8]cuda:0" = PlaceHolder[target=sum_3]
#   %add_13 : Tensor "f32[8, 1, 2048][2048, 16384, 1]cuda:0" = PlaceHolder[target=add_13]
#   %mul_22 : Tensor "f32[8, 1, 2048][2048, 16384, 1]cuda:0" = PlaceHolder[target=mul_22]
#   %mul_17 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, 2.3465413258596377), kwargs = {})
#   %add_12 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %bmm_14), kwargs = {})
#   %convert_element_type_34 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_12, torch.float32), kwargs = {})
#   %pow_3 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_34, 2), kwargs = {})
...
#   %mul_20 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mean, 512), kwargs = {})
...
#   %sub_7 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mean, %arg4_1), kwargs = {})
#   %mul_19 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_4, %sub_7), kwargs = {})
#   %where_5 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_2, %mean, %arg4_1), kwargs = {})
#   %add_13 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_19, %where_5), kwargs = {})
#   %clamp_min : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%add_13, 1e-10), kwargs = {})
#   %rsqrt : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%clamp_min,), kwargs = {})
#   %pow_4 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%rsqrt, 2), kwargs = {})
#   %mul_21 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_20, %pow_4), kwargs = {})
...
#   %mul_22 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%rsqrt, %div_1), kwargs = {})
#   %copy__2 : Tensor "f32[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg4_1, %add_13), kwargs = {})
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/tc/ctcqwfwddmfz7cjhevpucurwp4ibfgtmnkn4d5gks4dcxtf52rkc.py
...
# Graph fragment:
#   %copy__3 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=copy__3]
#   %arg5_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg5_1]
#   %expand_29 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=expand_29]
#   %bmm_14 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=bmm_14]
#   %mul_22 : Tensor "f32[8, 1, 2048][2048, 16384, 1]cuda:0" = PlaceHolder[target=mul_22]
#   %arg6_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg6_1]
#   %sub_8 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0" = PlaceHolder[target=sub_8]
...
#   %mul_17 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, 2.3465413258596377), kwargs = {})
#   %add_12 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %bmm_14), kwargs = {})
#   %convert_element_type_36 : Tensor "bf16[8, 1, 2048][2048, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_22, torch.bfloat16), kwargs = {})
#   %mul_23 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_12, %convert_element_type_36), kwargs = {})
#   %mul_25 : Tensor "bf16[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_37, %mul_23), kwargs = {})
...
#   %mul_27 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_26, %arg7_1), kwargs = {})
#   %mul_24 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_23, %arg7_1), kwargs = {})
#   %ge_3 : Tensor "b8[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%mul_24, 0), kwargs = {})
#   %mul_28 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_27, %ge_3), kwargs = {})
#   %add_14 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_25, %mul_28), kwargs = {})
#   %sub_8 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg7_1, %add_14), kwargs = {})
#   %copy__3 : Tensor "f32[8, 512, 2048][1048576, 2048, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg7_1, %sub_8), kwargs = {})
#   return %sub_8,%buf59
...
def triton_poi_fused__to_copy_add_copy__ge_mul_sub_14(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp8 = tl.load(in_ptr4 + (x0 + 2048*x2), None, eviction_policy='evict_last')
    tmp13 = in_ptr5
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg1_1, (8, 512, 2048), (1048576, 2048, 1))
        assert_size_stride(arg2_1, (8, 512, 2048), (1048576, 2048, 1))
        assert_size_stride(arg3_1, (), ())
        assert_size_stride(arg4_1, (8, 1, 2048), (2048, 2048, 1))
        assert_size_stride(arg5_1, (), ())
        assert_size_stride(arg6_1, (), ())
        assert_size_stride(arg7_1, (8, 512, 2048), (1048576, 2048, 1))
        with torch.cuda._DeviceGuard(0):
            ...
            buf2 = empty_strided_cuda((8, 512, 2048), (1048576, 2048, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [g, sub, lerp_, X, norm, mul, add, X_1], Original ATen: [aten.lerp, aten.rsub, aten._to_copy, aten.linalg_vector_norm, aten.mul, aten.add, aten.div, aten.copy_]
            stream0 = get_raw_stream(0)
            ...
            extern_kernels.bmm(buf2, reinterpret_tensor(buf2, (8, 2048, 512), (1048576, 1, 2048), 0), out=buf3)
            ...
            buf6 = empty_strided_cuda((8, 512, 2048), (1048576, 2048, 1), torch.bfloat16)
            ...
            buf7 = empty_strided_cuda((8, 512, 2048), (1048576, 2048, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_3, X_2], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            ...
            extern_kernels.bmm(buf7, reinterpret_tensor(buf7, (8, 2048, 512), (1048576, 1, 2048), 0), out=buf8)
            ...
            buf11 = empty_strided_cuda((8, 512, 2048), (1048576, 2048, 1), torch.bfloat16)
            ...
            extern_kernels.bmm(buf12, reinterpret_tensor(buf12, (8, 2048, 512), (1048576, 1, 2048), 0), out=buf13)
            ...
            buf16 = empty_strided_cuda((8, 512, 2048), (1048576, 2048, 1), torch.bfloat16)
            ...
            extern_kernels.bmm(buf17, reinterpret_tensor(buf17, (8, 2048, 512), (1048576, 1, 2048), 0), out=buf18)
            ...
            del buf19
            buf21 = empty_strided_cuda((8, 512, 2048), (1048576, 2048, 1), torch.bfloat16)
            ...
            extern_kernels.bmm(buf22, reinterpret_tensor(buf22, (8, 2048, 512), (1048576, 1, 2048), 0), out=buf23)
            ...
            del buf25
            buf27 = empty_strided_cuda((8, 1, 2048), (2048, 16384, 1), torch.float32)
            # Topologically Sorted Source Nodes: [mul_15, X_6, float_1, square, v_mean], Original ATen: [aten.mul, aten.add, aten._to_copy, aten.pow, aten.mean]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_mean_mul_pow_12.run(buf22, buf26, buf27, 16384, 512, stream=stream0)
            buf30 = empty_strided_cuda((8, 1, 2048), (2048, 16384, 1), torch.float32)
            # Topologically Sorted Source Nodes: [mul_15, X_6, float_1, square, v_mean, sum_1, v_norm_sq, v_norm, mul_17, beta2, sub_1, lerp__2, clamp_min, step_size, square_1, scaled_sq_sum, sum_2, v_norm_new, clamp_min_1, truediv_1, final_scale], Original ATen: [aten.mul, aten.add, aten._to_copy, aten.pow, aten.mean, aten.sum, aten.sqrt, aten.rsub, aten.lerp, aten.clamp_min, aten.rsqrt, aten.div, aten.copy_]
            stream0 = get_raw_stream(0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((8, 512, 2048), (1048576, 2048, 1), device='cuda:0', dtype=torch.float32)
    arg2_1 = rand_strided((8, 512, 2048), (1048576, 2048, 1), device='cuda:0', dtype=torch.float32)
    arg3_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg4_1 = rand_strided((8, 1, 2048), (2048, 2048, 1), device='cuda:0', dtype=torch.float32)
    arg5_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg6_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg7_1 = rand_strided((8, 512, 2048), (1048576, 2048, 1), device='cuda:0', dtype=torch.float32)
