...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/tx/ctxy6m2nzupga5epysoruzj3pgmd2zig464fmjx4fxk2l57g7nz5.py
...
#   %arg5_1 : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=arg5_1]
#   %copy__1 : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=copy__1]
#   %arg7_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg7_1]
#   %copy__2 : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=copy__2]
#   %arg8_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg8_1]
#   %arg9_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg9_1]
#   %copy_ : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=copy_]
#   %arg1_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg2_1]
#   %div_2 : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=div_2]
#   %convert_element_type_2 : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=convert_element_type_2]
#   %convert_element_type_5 : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=convert_element_type_5]
#   %add_3 : Tensor "bf16[8192, 512][512, 1]cuda:0" = PlaceHolder[target=add_3]
...
#   %mul_1 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg0_1, %sub), kwargs = {})
...
#   %convert_element_type_1 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg5_1, torch.float32), kwargs = {})
#   %convert_element_type : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg3_1, torch.float32), kwargs = {})
#   %sub_3 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_1, %convert_element_type), kwargs = {})
...
#   %where_1 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge, %convert_element_type_1, %convert_element_type), kwargs = {})
#   %add : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_2, %where_1), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add, torch.bfloat16), kwargs = {})
...
#   %pow_1 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%arg5_1, 2), kwargs = {})
#   %convert_element_type_4 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_1, torch.float32), kwargs = {})
#   %convert_element_type_3 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg6_1, torch.float32), kwargs = {})
#   %sub_6 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%convert_element_type_4, %convert_element_type_3), kwargs = {})
...
#   %where_3 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %convert_element_type_4, %convert_element_type_3), kwargs = {})
#   %add_1 : Tensor "f32[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_3, %where_3), kwargs = {})
#   %convert_element_type_5 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.bfloat16), kwargs = {})
...
#   %div : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_5, %sub_8), kwargs = {})
#   %sqrt : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%div,), kwargs = {})
#   %add_2 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sqrt, %arg9_1), kwargs = {})
#   %div_2 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_2, %add_2), kwargs = {})
...
#   %mul_4 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, %neg), kwargs = {})
#   %add_3 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_1, %mul_4), kwargs = {})
#   %copy_ : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg0_1, %add_3), kwargs = {})
#   %copy__1 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg3_1, %convert_element_type_2), kwargs = {})
#   %copy__2 : Tensor "bf16[8192, 512][512, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg6_1, %convert_element_type_5), kwargs = {})
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((8192, 512), (512, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    arg5_1 = rand_strided((8192, 512), (512, 1), device='cuda:0', dtype=torch.bfloat16)
    arg6_1 = rand_strided((8192, 512), (512, 1), device='cuda:0', dtype=torch.bfloat16)
