...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/bf/cbfb7zfo6com43phqw7wjiwdxb6xn5cli3cf4ktxotzv6kk6ulfo.py
...
#   %copy_ : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=copy_]
#   %copy__1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=copy__1]
...
#   %sub_2 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg1_1, %arg2_1), kwargs = {})
#   %mul : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where, %sub_2), kwargs = {})
#   %where_1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge, %arg1_1, %arg2_1), kwargs = {})
#   %add : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %where_1), kwargs = {})
#   %sub_4 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add, %arg1_1), kwargs = {})
#   %mul_1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_2, %sub_4), kwargs = {})
#   %where_3 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %add, %arg1_1), kwargs = {})
#   %add_1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_1, %where_3), kwargs = {})
#   %convert_element_type : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.bfloat16), kwargs = {})
#   %convert_element_type_1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_1, 2), kwargs = {})
#   %sum_1 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%pow_1, [-2, -1], True), kwargs = {})
#   return %buf0
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/fo/cfoxn77pi6dy5ngyktcnggiv6ew7u4ibw3es3xmzo2p33bygfqax.py
# Topologically Sorted Source Nodes: [g, sub, lerp_, X, norm], Original ATen: [aten.lerp, aten.rsub, aten._to_copy, aten.linalg_vector_norm]
# Source node to ATen node mapping:
#   X => convert_element_type
#   g => abs_2, add_1, ge_1, mul_1, sub_3, sub_4, where_2, where_3
...
#   sub => sub
# Graph fragment:
#   %buf0 : Tensor "f32[40, 1, 1, 13][13, 520, 520, 1]cuda:0" = PlaceHolder[target=buf0]
#   %abs_2 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%arg0_1,), kwargs = {})
#   %ge_1 : Tensor "b8[][]cpu"[num_users=2] = call_function[target=torch.ops.aten.ge.Scalar](args = (%abs_2, 0.5), kwargs = {})
#   %sub_3 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg0_1, 1), kwargs = {})
#   %where_2 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %sub_3, %arg0_1), kwargs = {})
...
def triton_per_fused__to_copy_lerp_linalg_vector_norm_rsub_1(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    r0_1 = r0_index
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (r0_1 + 13*x0), r0_mask & xmask, other=0.0)
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/am/cam3azjl4rxc2acejyazvhrjhadhl2rlr5fqpee2mqbl63yfxxh3.py
...
#   %copy_ : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=copy_]
#   %copy__1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=copy__1]
#   %sum_1 : Tensor "f32[40, 1, 1][1, 40, 40]cuda:0" = PlaceHolder[target=sum_1]
#   %add_1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=add_1]
#   %buf0 : Tensor "f32[40, 1, 1, 13][13, 520, 520, 1]cuda:0" = PlaceHolder[target=buf0]
#   %expand_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %add : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=add]
#   %abs_2 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.abs.default](args = (%arg0_1,), kwargs = {})
#   %ge_1 : Tensor "b8[][]cpu"[num_users=2] = call_function[target=torch.ops.aten.ge.Scalar](args = (%abs_2, 0.5), kwargs = {})
#   %sub_3 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg0_1, 1), kwargs = {})
#   %where_2 : Tensor "f32[][]cpu"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_1, %sub_3, %arg0_1), kwargs = {})
...
#   %add_1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_1, %where_3), kwargs = {})
#   %convert_element_type : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.bfloat16), kwargs = {})
#   %pow_2 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_1, 0.5), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_2, torch.bfloat16), kwargs = {})
#   %mul_2 : Tensor "bf16[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_2, 1.02), kwargs = {})
#   %add_2 : Tensor "bf16[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_2, 1e-06), kwargs = {})
#   %div : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type, %add_2), kwargs = {})
#   %copy_ : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg1_1, %add_1), kwargs = {})
#   %copy__1 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg2_1, %add), kwargs = {})
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/xc/cxc3t7uduh2hz47ahkvnc6qkvkpcbk66gkefgxgibogndmlop3mw.py
...
#   mul_2 => mul_4
# Graph fragment:
#   %expand_3 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_3]
#   %bmm_1 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_1]
#   %mul_3 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm, -22.48329292557795), kwargs = {})
#   %mul_4 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_1, 15.878769915207462), kwargs = {})
#   %add_3 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_3, %mul_4), kwargs = {})
#   return %expand_4
...
# Graph fragment:
#   %expand_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %bmm_2 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %mul_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   return %expand_11
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/un/cun6tsg5h3fvdjiqtkp2rib6izqmfhc5vs6xon4l7v5oii5prara.py
...
#   mul_5 => mul_7
# Graph fragment:
#   %expand_9 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_9]
#   %bmm_4 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_4]
#   %mul_6 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_3, -2.808917465908714), kwargs = {})
#   %mul_7 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_4, 0.5000178451051316), kwargs = {})
#   %add_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_6, %mul_7), kwargs = {})
#   return %expand_10
...
#   %expand_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_5]
#   %bmm_2 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %bmm_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %mul_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   return %expand_17
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/ty/ctyygtiqof276gweu5isdty633i6md4o6ikfez45akxzxhz2i3jx.py
...
#   mul_8 => mul_10
# Graph fragment:
#   %expand_15 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_15]
#   %bmm_7 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_7]
#   %mul_9 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_6, -2.772484153217685), kwargs = {})
#   %mul_10 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_7, 0.5060648178503393), kwargs = {})
#   %add_7 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_9, %mul_10), kwargs = {})
#   return %expand_16
...
#   %bmm_2 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_2]
#   %bmm_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %bmm_8 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_8]
#   %mul_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   %mul_11 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_6, 3.8916678022926607), kwargs = {})
#   %add_8 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %bmm_8), kwargs = {})
#   return %expand_23
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/xp/cxpitugfirlswejqjqowezl3eoqfgmexaadca5zol6rf7a3tnjvq.py
...
#   mul_11 => mul_13
# Graph fragment:
#   %expand_21 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_21]
#   %bmm_10 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_10]
#   %mul_12 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_9, -2.3681294933425376), kwargs = {})
#   %mul_13 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_10, 0.46449024233003106), kwargs = {})
#   %add_9 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_12, %mul_13), kwargs = {})
#   return %expand_22
...
#   %bmm_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_5]
#   %bmm_8 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_8]
#   %bmm_11 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_11]
#   %mul_5 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 8.156554524902461), kwargs = {})
#   %add_4 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %bmm_2), kwargs = {})
#   %mul_8 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_4, 4.042929935166739), kwargs = {})
#   %add_6 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %bmm_5), kwargs = {})
#   %mul_11 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_6, 3.8916678022926607), kwargs = {})
#   %add_8 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_11, %bmm_8), kwargs = {})
#   %mul_14 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, 3.285753657755655), kwargs = {})
#   %add_10 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_14, %bmm_11), kwargs = {})
#   return %expand_29
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/6g/c6gjnumdlq4syf24cklr5uqzucbyap3obievw5l4nfaxgxzmvfk2.py
...
#   mul_14 => mul_16
# Graph fragment:
#   %expand_27 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_27]
#   %bmm_13 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_13]
#   %mul_15 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_12, -1.7097828382687081), kwargs = {})
#   %mul_16 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%bmm_13, 0.42323551169305323), kwargs = {})
#   %add_11 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_15, %mul_16), kwargs = {})
#   return %expand_28
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/k2/ck2jq6cml32ilznhhbbdb4iroogkjoaclhcocpc2hhpmlzdxkbbp.py
...
#   v_mean => mean
# Graph fragment:
#   %expand_29 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_29]
#   %bmm_14 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_14]
#   %mul_17 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, 2.3465413258596377), kwargs = {})
#   %add_12 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %bmm_14), kwargs = {})
#   %convert_element_type_34 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_12, torch.float32), kwargs = {})
#   %pow_3 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_34, 2), kwargs = {})
#   %mean : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_3, [-1], True), kwargs = {})
#   return %buf27
...
def triton_per_fused__to_copy_add_mean_mul_pow_12(in_ptr0, in_ptr1, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    r0_1 = r0_index
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (r0_1 + 640*x0), r0_mask & xmask, other=0.0).to(tl.float32)
    tmp3 = tl.load(in_ptr1 + (r0_1 + 640*x0), r0_mask & xmask, other=0.0).to(tl.float32)
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/3i/c3ip527wac33v6erkwph2vnwen2pgugadhmgg245p3eai26hn5wq.py
...
#   v_norm_sq => mul_18
# Graph fragment:
#   %buf27 : Tensor "f32[40, 640, 1][640, 1, 25600]cuda:0" = PlaceHolder[target=buf27]
#   %arg3_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg3_1]
#   %copy__2 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0" = PlaceHolder[target=copy__2]
#   %sum_2 : Tensor "f32[40, 1, 1][1, 40, 40]cuda:0" = PlaceHolder[target=sum_2]
#   %sum_3 : Tensor "f32[40, 1, 1][1, 40, 40]cuda:0" = PlaceHolder[target=sum_3]
#   %add_13 : Tensor "f32[40, 640, 1][640, 1, 25600]cuda:0" = PlaceHolder[target=add_13]
#   %mul_22 : Tensor "f32[40, 640, 1][640, 1, 25600]cuda:0" = PlaceHolder[target=mul_22]
#   %mul_17 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, 2.3465413258596377), kwargs = {})
#   %add_12 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %bmm_14), kwargs = {})
#   %convert_element_type_34 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_12, torch.float32), kwargs = {})
#   %pow_3 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_34, 2), kwargs = {})
#   %mean : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=4] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_3, [-1], True), kwargs = {})
#   %sum_2 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mean, [-2, -1], True), kwargs = {})
#   %mul_18 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_2, 640), kwargs = {})
#   %sqrt : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%mul_18,), kwargs = {})
#   %mul_20 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mean, 640), kwargs = {})
...
#   %sub_7 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mean, %arg4_1), kwargs = {})
#   %mul_19 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_4, %sub_7), kwargs = {})
#   %where_5 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge_2, %mean, %arg4_1), kwargs = {})
#   %add_13 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_19, %where_5), kwargs = {})
#   %clamp_min : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%add_13, 1e-10), kwargs = {})
#   %rsqrt : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%clamp_min,), kwargs = {})
#   %pow_4 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%rsqrt, 2), kwargs = {})
#   %mul_21 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_20, %pow_4), kwargs = {})
#   %sum_3 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_21, [-2, -1], True), kwargs = {})
#   %sqrt_1 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sqrt.default](args = (%sum_3,), kwargs = {})
#   %clamp_min_1 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%sqrt_1, 1e-10), kwargs = {})
#   %div_1 : Tensor "f32[40, 1, 1][1, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sqrt, %clamp_min_1), kwargs = {})
#   %mul_22 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%rsqrt, %div_1), kwargs = {})
#   %copy__2 : Tensor "f32[40, 640, 1][640, 1, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg4_1, %add_13), kwargs = {})
#   return %sum_2,%sum_3,%mul_22,%add_13,%buf52
triton_per_fused__to_copy_add_clamp_min_copy__div_lerp_mean_mul_pow_rsqrt_rsub_sqrt_sum_13 = async_compile.triton('triton_per_fused__to_copy_add_clamp_min_copy__div_lerp_mean_mul_pow_rsqrt_rsub_sqrt_sum_13', '''
import triton
import triton.language as tl
...
# kernel path: /mnt/weka/home/junlin.chen/workspace/autoresearch/autoresearch/.torchinductor-cache/ur/cur2dm5fgds23cfc4pfaw3fv47np7bofb4wfepbofzi2gysghj24.py
...
# Graph fragment:
#   %copy__3 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=copy__3]
#   %arg5_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg5_1]
#   %expand_29 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=expand_29]
#   %bmm_14 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=bmm_14]
#   %mul_22 : Tensor "f32[40, 640, 1][640, 1, 25600]cuda:0" = PlaceHolder[target=mul_22]
#   %arg6_1 : Tensor "f32[][]cpu" = PlaceHolder[target=arg6_1]
#   %sub_8 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0" = PlaceHolder[target=sub_8]
...
#   %mul_17 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, 2.3465413258596377), kwargs = {})
#   %add_12 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %bmm_14), kwargs = {})
#   %convert_element_type_36 : Tensor "bf16[40, 640, 1][640, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_22, torch.bfloat16), kwargs = {})
#   %mul_23 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_12, %convert_element_type_36), kwargs = {})
#   %mul_25 : Tensor "bf16[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_37, %mul_23), kwargs = {})
...
#   %mul_27 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_26, %arg7_1), kwargs = {})
#   %mul_24 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_23, %arg7_1), kwargs = {})
#   %ge_3 : Tensor "b8[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%mul_24, 0), kwargs = {})
#   %mul_28 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_27, %ge_3), kwargs = {})
#   %add_14 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_25, %mul_28), kwargs = {})
#   %sub_8 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg7_1, %add_14), kwargs = {})
#   %copy__3 : Tensor "f32[40, 640, 640][409600, 640, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg7_1, %sub_8), kwargs = {})
#   return %sub_8,%buf59
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg1_1, (40, 640, 640), (409600, 640, 1))
        assert_size_stride(arg2_1, (40, 640, 640), (409600, 640, 1))
        assert_size_stride(arg3_1, (), ())
        assert_size_stride(arg4_1, (40, 640, 1), (640, 1, 1))
        assert_size_stride(arg5_1, (), ())
        assert_size_stride(arg6_1, (), ())
        assert_size_stride(arg7_1, (40, 640, 640), (409600, 640, 1))
        with torch.cuda._DeviceGuard(0):
            torch.cuda.set_device(0)
            buf0 = empty_strided_cuda((40, 1, 1, 13), (13, 520, 520, 1), torch.float32)
            # Topologically Sorted Source Nodes: [g, sub, lerp_, X, norm], Original ATen: [aten.lerp, aten.rsub, aten._to_copy, aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_lerp_linalg_vector_norm_rsub_0.run(arg0_1.item(), arg1_1, arg2_1, buf0, 520, 31508, stream=stream0)
            buf1 = empty_strided_cuda((40, 1, 1), (1, 40, 40), torch.float32)
            # Topologically Sorted Source Nodes: [g, sub, lerp_, X, norm], Original ATen: [aten.lerp, aten.rsub, aten._to_copy, aten.linalg_vector_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_lerp_linalg_vector_norm_rsub_1.run(buf0, buf1, 40, 13, stream=stream0)
            buf2 = empty_strided_cuda((40, 640, 640), (409600, 640, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [g, sub, lerp_, X, norm, mul, add, X_1], Original ATen: [aten.lerp, aten.rsub, aten._to_copy, aten.linalg_vector_norm, aten.mul, aten.add, aten.div, aten.copy_]
            stream0 = get_raw_stream(0)
            ...
            del buf0
            del buf1
            buf3 = empty_strided_cuda((40, 640, 640), (409600, 640, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getattr_1, A], Original ATen: [aten.transpose, aten.bmm]
            extern_kernels.bmm(buf2, reinterpret_tensor(buf2, (40, 640, 640), (409600, 1, 640), 0), out=buf3)
            buf4 = empty_strided_cuda((40, 640, 640), (409600, 640, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_1], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf3, buf3, out=buf4)
            buf5 = buf3; del buf3  # reuse
            # Topologically Sorted Source Nodes: [mul_1, mul_2, B], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_3.run(buf5, buf4, 16384000, stream=stream0)
            ...
            buf8 = empty_strided_cuda((40, 640, 640), (409600, 640, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_3, X_2, getattr_2, A_1], Original ATen: [aten.mul, aten.add, aten.transpose, aten.bmm]
            extern_kernels.bmm(buf7, reinterpret_tensor(buf7, (40, 640, 640), (409600, 1, 640), 0), out=buf8)
            buf9 = empty_strided_cuda((40, 640, 640), (409600, 640, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_4], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf8, buf8, out=buf9)
            buf10 = buf8; del buf8  # reuse
            # Topologically Sorted Source Nodes: [mul_4, mul_5, B_1], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_5.run(buf10, buf9, 16384000, stream=stream0)
            ...
            extern_kernels.bmm(buf12, reinterpret_tensor(buf12, (40, 640, 640), (409600, 1, 640), 0), out=buf13)
            buf14 = empty_strided_cuda((40, 640, 640), (409600, 640, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_7], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf13, buf13, out=buf14)
            buf15 = buf13; del buf13  # reuse
            # Topologically Sorted Source Nodes: [mul_7, mul_8, B_2], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_7.run(buf15, buf14, 16384000, stream=stream0)
            ...
            extern_kernels.bmm(buf17, reinterpret_tensor(buf17, (40, 640, 640), (409600, 1, 640), 0), out=buf18)
            buf19 = empty_strided_cuda((40, 640, 640), (409600, 640, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [matmul_10], Original ATen: [aten.bmm]
            extern_kernels.bmm(buf18, buf18, out=buf19)
            buf20 = buf18; del buf18  # reuse
            # Topologically Sorted Source Nodes: [mul_10, mul_11, B_3], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_9.run(buf20, buf19, 16384000, stream=stream0)
            ...
            extern_kernels.bmm(buf22, reinterpret_tensor(buf22, (40, 640, 640), (409600, 1, 640), 0), out=buf23)
            ...
            # Topologically Sorted Source Nodes: [mul_13, mul_14, B_4], Original ATen: [aten.mul, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_mul_11.run(buf25, buf24, 16384000, stream=stream0)
            ...
            del buf25
            buf27 = empty_strided_cuda((40, 640, 1), (640, 1, 25600), torch.float32)
            # Topologically Sorted Source Nodes: [mul_15, X_6, float_1, square, v_mean], Original ATen: [aten.mul, aten.add, aten._to_copy, aten.pow, aten.mean]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_mean_mul_pow_12.run(buf22, buf26, buf27, 25600, 640, stream=stream0)
            buf30 = empty_strided_cuda((40, 640, 1), (640, 1, 25600), torch.float32)
            # Topologically Sorted Source Nodes: [mul_15, X_6, float_1, square, v_mean, sum_1, v_norm_sq, v_norm, mul_17, beta2, sub_1, lerp__2, clamp_min, step_size, square_1, scaled_sq_sum, sum_2, v_norm_new, clamp_min_1, truediv_1, final_scale], Original ATen: [aten.mul, aten.add, aten._to_copy, aten.pow, aten.mean, aten.sum, aten.sqrt, aten.rsub, aten.lerp, aten.clamp_min, aten.rsqrt, aten.div, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_per_fused__to_copy_add_clamp_min_copy__div_lerp_mean_mul_pow_rsqrt_rsub_sqrt_sum_13.run(buf27, arg3_1.item(), arg4_1, buf30, arg4_1, 40, 640, stream=stream0)
            del arg3_1
            del arg4_1
            del buf27
            # Topologically Sorted Source Nodes: [lr, mul_15, X_6, to_3, g_1, mul_22, wd, mul_23, mul_24, mul_21, mask, mul_25, add_11, sub_], Original ATen: [aten._to_copy, aten.mul, aten.add, aten.ge, aten.sub, aten.copy_]
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((40, 640, 640), (409600, 640, 1), device='cuda:0', dtype=torch.float32)
    arg2_1 = rand_strided((40, 640, 640), (409600, 640, 1), device='cuda:0', dtype=torch.float32)
    arg3_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg4_1 = rand_strided((40, 640, 1), (640, 1, 1), device='cuda:0', dtype=torch.float32)
    arg5_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg6_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    arg7_1 = rand_strided((40, 640, 640), (409600, 640, 1), device='cuda:0', dtype=torch.float32)
